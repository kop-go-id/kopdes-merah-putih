...
export default function Step2Develop() {
  ...
  return (
    <div className="min-h-screen flex bg-white text-[#121212] font-sans">
      {/* Sidebar */}
      <aside className="w-[300px] bg-primary text-white px-6 py-10 rounded-r-3xl">
        <div className="mb-10">
          <img src="/logo-koperasi.png" alt="Logo" className="w-32 mb-6" />
          <div className="space-y-6">
            <div className="flex items-start space-x-3">
              <div className="h-5 w-5 rounded-full bg-white text-primary flex items-center justify-center text-sm font-bold">✓</div>
              <div>
      ...
      <main className="flex-1 px-10 py-12">
        <h2 className="text-2xl font-bold text-primary">Informasi Data Koperasi</h2>
        ...
        <form className="space-y-4 max-w-3xl">
          ...
          <div>
            <label className="block font-semibold mb-1">
              ...
              <button type="button" className="ml-2 text-white bg-primary text-xs px-2 py-1 rounded">
