...
export default function RegisterStep2() {
  ...
  return (
    <div className="min-h-screen flex bg-white text-[#121212] font-sans">
      {/* Sidebar */}
      <aside className="w-[320px] bg-primary text-white flex flex-col justify-between py-10 px-6 rounded-r-[32px]">
        <div>
          <div className="mb-10">
        ...
        <div className="space-y-6 max-w-2xl w-full">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <button className="text-xs px-2 py-1 bg-primary text-white rounded">
          ...
          <div className="flex justify-between mt-8">
            ...
            <button
              onClick={handleNext}
              className="bg-primary text-white px-6 py-2 rounded-lg hover:bg-[#024956]"
            >
              Berikutnya
            </button>
          </div>
...
function StepItem({ label, desc, active, checked }) {
  return (
    <div className="flex items-start space-x-4">
      <div className="mt-1">
        {checked ? (
          <div className="w-5 h-5 bg-white rounded-full flex items-center justify-center text-primary text-sm font-bold">
            ✓
          </div>
        ) : active ? (
